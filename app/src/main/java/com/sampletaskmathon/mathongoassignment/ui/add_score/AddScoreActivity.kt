...
import com.sampletaskmathon.mathongoassignment.databinding.ActivityAddScoreBinding
...
class AddScoreActivity : AppCompatActivity() {
    ...
    private fun makeScoreCard() : AddScoreModel{
        ...
        return AddScoreModel(AppPreference.fetchSharedPrefString(this,AppPreference.USER_EMAIL)!!,
